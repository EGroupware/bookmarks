 ...
 * @return string
 */
function bookmarks_upgrade19_1()
{
	return $GLOBALS['setup_info']['bookmarks']['currentver'] = '20.1';
}
 ...
 * @return string
 */
function bookmarks_upgrade20_1()
{
 ...
 * @return string
 */
function bookmarks_upgrade23_1()
{
	return $GLOBALS['setup_info']['bookmarks']['currentver'] = '26.1';
}